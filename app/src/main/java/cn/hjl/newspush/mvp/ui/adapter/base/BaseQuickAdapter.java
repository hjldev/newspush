...
import cn.hjl.newspush.mvp.ui.adapter.animation.AlphaInAnimation;
import cn.hjl.newspush.mvp.ui.adapter.animation.BaseAnimation;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public void removeAll(){
        ...
        //FIXME 执行次方法，导致滑动到中间部位，暂时没找到原因
//        notifyItemRangeRemoved(getHeaderLayoutCount(), mData.size());
        mData.clear();
